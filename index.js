...
const UUID = process.env.UUID || '1cdcfb13-a5dd-4a5c-8d37-5ec7e88db368'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'cctv.nyc.mn:443';       // 哪吒v1填写形式：nz.abc.com:8008   哪吒v0填写形式：nz.abc.com
const NEZHA_PORT = process.env.NEZHA_PORT || '';           // 哪吒v1没有此变量，v0的agent端口为{443,8443,2096,2087,2083,2053}其中之一时开启tls
const NEZHA_KEY = process.env.NEZHA_KEY || '6DlSFy5UbbuWGjwswY3hYFQQZlBaDc1p';             // v1的NZ_CLIENT_SECRET或v0的agent端口                
...
const NAME = process.env.NAME || 'Myface';                       // 节点名称
